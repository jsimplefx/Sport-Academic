...
public class CountriesViewController implements Initializable {
    ...
    private void checkAnswer(JFXButton selected, int quenum){
        ...
        int points = 10;
        switch (quenum){
            case 0: if (selected.getText().equals(Options[0][3])) Score.setText(String.valueOf(current + points)); break;
            case 1: if (selected.getText().equals(Options[1][2])) Score.setText(String.valueOf(current + points)); break;
            case 2: if (selected.getText().equals(Options[2][1])) Score.setText(String.valueOf(current + points)); break;
            case 3: if (selected.getText().equals(Options[3][3])) Score.setText(String.valueOf(current + points)); break;
            case 4: if (selected.getText().equals(Options[4][2])) Score.setText(String.valueOf(current + points)); break;
            ...
            case 8: if (selected.getText().equals(Options[8][0])) Score.setText(String.valueOf(current + points)); break;
            case 9: if (selected.getText().equals(Options[9][1])) Score.setText(String.valueOf(current + points)); break;
            ...
            case 14: if (selected.getText().equals(Options[14][2])) Score.setText(String.valueOf(current + points)); break;
