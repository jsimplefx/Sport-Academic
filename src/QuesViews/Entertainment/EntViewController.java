...
public class EntViewController implements Initializable {
    ...
    private void checkAnswer(JFXButton selected, int quenum){
        ...
        switch (quenum){
            ...
            case 3: if (selected.getText().equals(Options[3][1])) Score.setText(String.valueOf(current + points)); break;
            ...
            case 12: if (selected.getText().equals(Options[12][0])) Score.setText(String.valueOf(current + points)); break;
