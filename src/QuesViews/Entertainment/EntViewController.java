...
public class EntViewController implements Initializable {
    ...
    public static void setCurrent(int current) {
        EntViewController.current = current;
    }
    ...
    private void setBtns(JFXButton[] ans, int quenum, Label que) {
        for (int i = 0; i < ans.length; i++) {
            ...
            ans[i].setStyle("-fx-cursor: hand;"); // change the cursor to hand
            ans[i].setFont(Font.font(16)); // set font size
        }
    ...
    private void checkAnswer(JFXButton selected, int quenum) {
        ...
        switch (quenum) {
            ...
            case 1:
                ...
                break;
            case 2:
                if (selected.getText().equals(Options[2][0])) Score.setText(String.valueOf(current + points));
                break;
            case 3:
                if (selected.getText().equals(Options[3][1])) Score.setText(String.valueOf(current + points));
                break;
            case 4:
                if (selected.getText().equals(Options[4][2])) Score.setText(String.valueOf(current + points));
                break;
            case 5:
                if (selected.getText().equals(Options[5][1])) Score.setText(String.valueOf(current + points));
                break;
            case 6:
                if (selected.getText().equals(Options[6][1])) Score.setText(String.valueOf(current + points));
                break;
            case 7:
                if (selected.getText().equals(Options[7][2])) Score.setText(String.valueOf(current + points));
                break;
            case 8:
                if (selected.getText().equals(Options[8][2])) Score.setText(String.valueOf(current + points));
                break;
            case 9:
                if (selected.getText().equals(Options[9][1])) Score.setText(String.valueOf(current + points));
                break;
            case 10:
                if (selected.getText().equals(Options[10][0])) Score.setText(String.valueOf(current + points));
                break;
            case 11:
                if (selected.getText().equals(Options[11][1])) Score.setText(String.valueOf(current + points));
                break;
            case 12:
                if (selected.getText().equals(Options[12][0])) Score.setText(String.valueOf(current + points));
                break;
            case 13:
                if (selected.getText().equals(Options[13][1])) Score.setText(String.valueOf(current + points));
                break;
            case 14:
                if (selected.getText().equals(Options[14][1])) Score.setText(String.valueOf(current + points));
                break;
            case 15:
                if (selected.getText().equals(Options[15][0])) Score.setText(String.valueOf(current + points));
                break;
        }
    }
