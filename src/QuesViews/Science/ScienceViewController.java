    ...
    private void checkAnswer(JFXButton selected, int quenum) {
        ...
        switch (quenum) {
            ...
            case 2:
                ...
                break;
            case 3:
                if (selected.getText().equals(Options[3][2])) Score.setText(String.valueOf(current + points));
                break;
            case 4:
                if (selected.getText().equals(Options[4][3])) Score.setText(String.valueOf(current + points));
                break;
            case 5:
                if (selected.getText().equals(Options[5][0])) Score.setText(String.valueOf(current + points));
                break;
            case 6:
            ...
            case 7:
                ...
                break;
            case 8:
                if (selected.getText().equals(Options[8][1])) Score.setText(String.valueOf(current + points));
                break;
            case 9:
            ...
            case 11:
                ...
                break;
            case 12:
                if (selected.getText().equals(Options[12][3])) Score.setText(String.valueOf(current + points));
                break;
            case 13:
